...
public class Tutorial_GrapplingGun : NetworkBehaviour
{
    [Header("Scripts Ref:")] public Tutorial_GrapplingRope grappleRope;
    //public Tutorial_GrapplingGun otherGrapplingGun;

    [Header("Controls:")] public KeyCode mouseButton;
